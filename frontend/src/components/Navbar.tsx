      ...
      <div className="navbar-inner">
        ...
        <div className="navbar-links">
          <Link to="/" className="navbar-link">
            <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ display:'inline', marginRight:4 }}>
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
            </svg>
            Courses
          </Link>
          {isAuthenticated && isInstructor && (
            <Link to="/instructor-dashboard" className="navbar-link" style={{ color:'#818cf8' }}>
              <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ display:'inline', marginRight:4 }}>
          ...
          {isAuthenticated ? (
            <>
              <span className="navbar-welcome">
                <svg width="13" height="13" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ display:'inline', marginRight:4 }}>
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
                {user?.firstName || 'User'}
                {isInstructor && <span style={{ marginLeft:6, fontSize:'.7rem', fontWeight:700, color:'#818cf8' }}>INSTRUCTOR</span>}
              </span>
