    ...
    <nav className="navbar">
      <div className="navbar-inner">
        ...
        <div className="navbar-links">
          ...
          {isAuthenticated && isInstructor && (
            <Link to="/instructor-dashboard" className="navbar-link" style={{ color: isAdmin ? '#34d399' : '#818cf8' }}>
              <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {isAuthenticated ? (
            <>
              <div className="navbar-welcome">
                ...
                {user?.firstName || 'User'}
                {isAdmin ? <span className="instructor-tag" style={{ background:'rgba(52,211,153,.15)', color:'#34d399' }}>ADMIN</span> : isInstructor && <span className="instructor-tag">INSTRUCTOR</span>}
              </div>
